...
sql_generation_few_shot_prompt = """Table advisor, columns = [*,s_ID,i_ID]
Table classroom, columns = [*,building,room_number,capacity]
Table course, columns = [*,course_id,title,dept_name,credits]
Q: "Find the buildings which have rooms with capacity more than 50."
Schema_links: [classroom.building,classroom.capacity,50]
...
sql_generation_medium_few_shot_prompt = """Table department, columns = [*,dept_name,building,budget]
...
Table section, columns = [*,course_id,sec_id,semester,year,building,room_number,time_slot_id]
Table student, columns = [*,ID,name,dept_name,tot_cred]
Foreign_keys = [instructor.dept_name = department.dept_name,student.dept_name = department.dept_name]
Q: "Find the total number of students and total number of instructors for each department."
...
Foreign_keys = [teaches.course_id = course.course_id,teaches.id = instructor.id]
